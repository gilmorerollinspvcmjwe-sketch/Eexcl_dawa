...
export const PVZ_PLANTS: PvZPlantDefinition[] = [
  ...
  definePlant({ id: 'cattail', name: '猫尾草', shortName: '尾', summary: '高价值追踪位，当前阶段按稳定多线输出处理。', archetype: 'shooter', implementation: 'planned', unlockLevel: '8-06', chapterAffinity: ['pool'], tags: ['输出', '追踪'], cost: 225, cooldownMs: 9000, maxHp: 300, damage: 24, attackIntervalMs: 1100, projectileKind: 'pea', projectileCount: 1, multiLane: 'all', runtimeAliasOf: 'threepeater' }),
  ...
  definePlant({ id: 'reedPult', name: '香蒲投手', shortName: '香投', summary: '水面追踪抛投位，当前阶段按多线抛投接入。', archetype: 'lobber', implementation: 'planned', unlockLevel: '8-06', chapterAffinity: ['pool'], tags: ['输出', '追踪', '抛投'], cost: 225, cooldownMs: 9000, maxHp: 300, damage: 40, attackIntervalMs: 1600, projectileKind: 'lobbed', projectileCount: 1, multiLane: 'all', runtimeAliasOf: 'cabbagePult' }),
  ...
  definePlant({ id: 'umbrellaLeaf', name: '伞叶草', shortName: '伞', summary: '防投掷保护位，当前阶段按护盾支援位接入。', archetype: 'support', implementation: 'planned', unlockLevel: '7-07', chapterAffinity: ['fog', 'roof'], tags: ['保护', '支援'], cost: 100, cooldownMs: 8500, maxHp: 300, supportEffect: 'shield', runtimeAliasOf: 'pumpkin' }),
  ...
  definePlant({ id: 'doomShroom', name: '毁灭菇', shortName: '灭', summary: '超大范围终局爆发，当前阶段按巨型炸弹处理。', archetype: 'bomb', implementation: 'planned', unlockLevel: '10-09', chapterAffinity: ['night', 'lab'], tags: ['爆发', '终局'], cost: 200, cooldownMs: 65000, maxHp: 1, damage: 1800, explodeRadius: 5, runtimeAliasOf: 'cherryBomb' }),
  ...
  definePlant({ id: 'hypnoShroom', name: '催眠蘑菇', shortName: '眠', summary: '反转控制位，当前阶段按近战单解卡承载。', archetype: 'special', implementation: 'planned', unlockLevel: '9-08', chapterAffinity: ['night', 'lab'], tags: ['控制', '特殊'], cost: 75, cooldownMs: 20000, maxHp: 200, damage: 900, attackIntervalMs: 2400, runtimeAliasOf: 'chomper' }),
