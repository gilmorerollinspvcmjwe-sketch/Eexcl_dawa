...
export const PVZ_PLANTS: PvZPlantDefinition[] = [
  ...
  definePlant({ id: 'sunShroom', name: '阳光菇', shortName: '菇', summary: '夜间低费经济，前期更适合资源压缩关。', archetype: 'economy', implementation: 'full', unlockLevel: '2-01', chapterAffinity: ['night'], tags: ['经济', '夜间'], cost: 25, cooldownMs: 7500, maxHp: 240, producesSun: true, sunIntervalMs: 5000, sunAmount: 15 }),
  definePlant({ id: 'coffeeBean', name: '咖啡豆', shortName: '咖', summary: '唤醒辅助位，激活休眠植物。', archetype: 'support', implementation: 'full', unlockLevel: '9-01', chapterAffinity: ['night', 'lab'], tags: ['辅助', '唤醒'], cost: 75, cooldownMs: 12000, maxHp: 200, supportEffect: 'shield' }),
  definePlant({ id: 'imitater', name: '模仿者', shortName: '仿', summary: '高阶复制位，通用输出副卡。', archetype: 'special', implementation: 'full', unlockLevel: '9-01', chapterAffinity: ['lab'], tags: ['特殊', '复制'], cost: 125, cooldownMs: 15000, maxHp: 260, damage: 20, attackIntervalMs: 1400, projectileKind: 'pea', projectileCount: 1 }),
  ...
  definePlant({ id: 'goldLeaf', name: '金叶草', shortName: '金', summary: '资源外溢位，高价值产光。', archetype: 'economy', implementation: 'full', unlockLevel: '9-06', chapterAffinity: ['roof', 'lab'], tags: ['经济', '奖励'], cost: 75, cooldownMs: 10000, maxHp: 240, producesSun: true, sunIntervalMs: 5000, sunAmount: 40 }),
  ...
  definePlant({ id: 'torchwood', name: '火炬树桩', shortName: '炬', summary: '火力强化位，将经过的豌豆弹道变为火系。', archetype: 'support', implementation: 'full', unlockLevel: '2-05', chapterAffinity: ['night', 'roof'], tags: ['强化', '火系'], cost: 175, cooldownMs: 7500, maxHp: 300, supportEffect: 'torch' }),
  ...
  definePlant({ id: 'cactus', name: '仙人掌', shortName: '仙', summary: '反空特化输出，优先攻击空中单位。', archetype: 'shooter', implementation: 'full', unlockLevel: '8-07', chapterAffinity: ['pool', 'all'], tags: ['输出', '反空'], cost: 125, cooldownMs: 7500, maxHp: 300, damage: 22, attackIntervalMs: 1200, projectileKind: 'pea', projectileCount: 1 }),
  ...
  definePlant({ id: 'twoHeadedPea', name: '双头豌豆', shortName: '双头', summary: '高阶双向压制，强化双发。', archetype: 'shooter', implementation: 'full', unlockLevel: '8-05', chapterAffinity: ['night', 'all'], tags: ['输出', '双向'], cost: 225, cooldownMs: 9000, maxHp: 300, damage: 20, attackIntervalMs: 1200, projectileKind: 'double-pea', projectileCount: 2 }),
  ...
  definePlant({ id: 'kernelPult', name: '玉米投手', shortName: '米', summary: '稳定抛投位，概率硬控。', archetype: 'lobber', implementation: 'full', unlockLevel: '5-03', chapterAffinity: ['roof'], tags: ['输出', '抛投'], cost: 100, cooldownMs: 7500, maxHp: 300, damage: 30, attackIntervalMs: 1800, projectileKind: 'lobbed', projectileCount: 1 }),
  ...
  definePlant({ id: 'cobCannon', name: '玉米加农炮', shortName: '炮', summary: '终局大炮位，高额爆发抛投。', archetype: 'special', implementation: 'full', unlockLevel: '10-06', chapterAffinity: ['roof', 'all'], tags: ['爆发', '终局'], cost: 500, cooldownMs: 30000, maxHp: 350, damage: 700, explodeRadius: 5, attackIntervalMs: 8000, projectileKind: 'lobbed', projectileCount: 1 }),
  ...
  definePlant({ id: 'plantern', name: '灯笼草', shortName: '灯', summary: '迷雾侦察位，照亮周围区域。', archetype: 'support', implementation: 'full', unlockLevel: '4-03', chapterAffinity: ['fog'], tags: ['侦察', '支援'], cost: 25, cooldownMs: 7500, maxHp: 300, supportEffect: 'reveal' }),
  ...
  definePlant({ id: 'steelSpikeweed', name: '钢地刺', shortName: '钢刺', summary: '对重甲更强的通路陷阱。', archetype: 'spike', implementation: 'full', unlockLevel: '9-04', chapterAffinity: ['roof', 'lab'], tags: ['陷阱', '反甲'], cost: 200, cooldownMs: 9000, maxHp: 420, damage: 50, attackIntervalMs: 900 }),
  ...
  definePlant({ id: 'powderShroom', name: '火药蘑菇', shortName: '粉', summary: '夜间中范围爆发位。', archetype: 'bomb', implementation: 'full', unlockLevel: '9-05', chapterAffinity: ['night', 'lab'], tags: ['爆发', '夜间'], cost: 100, cooldownMs: 30000, maxHp: 1, damage: 800, explodeRadius: 3 }),
  ...
  definePlant({ id: 'fireMine', name: '火焰豌豆雷', shortName: '火雷', summary: '带灼烧概念的爆发陷阱，强化土豆雷。', archetype: 'trap', implementation: 'full', unlockLevel: '9-03', chapterAffinity: ['lab'], tags: ['陷阱', '火系'], cost: 50, cooldownMs: 28000, maxHp: 1, damage: 1100, attackIntervalMs: 9000 }),
  definePlant({ id: 'starMine', name: '杨桃雷', shortName: '星雷', summary: '多向碎裂概念的陷阱位，范围雷。', archetype: 'trap', implementation: 'full', unlockLevel: '9-04', chapterAffinity: ['lab'], tags: ['陷阱', '多向'], cost: 75, cooldownMs: 26000, maxHp: 1, damage: 1000, explodeRadius: 3, attackIntervalMs: 9000 }),
  definePlant({ id: 'butterCannon', name: '玉米黄油炮', shortName: '黄炮', summary: '远程硬控爆发位，抛投控制炮。', archetype: 'special', implementation: 'full', unlockLevel: '9-06', chapterAffinity: ['roof', 'lab'], tags: ['控制', '爆发'], cost: 225, cooldownMs: 24000, maxHp: 300, damage: 260, attackIntervalMs: 3000, projectileKind: 'lobbed', projectileCount: 1 }),
  ...
  definePlant({ id: 'puffShroom', name: '小喷菇', shortName: '喷', summary: '夜间低费近程输出。', archetype: 'shooter', implementation: 'full', unlockLevel: '2-02', chapterAffinity: ['night'], tags: ['输出', '低费'], cost: 25, cooldownMs: 5500, maxHp: 220, damage: 15, attackIntervalMs: 1200, projectileKind: 'pea', projectileCount: 1 }),
  definePlant({ id: 'scaredyShroom', name: '胆小菇', shortName: '胆', summary: '脆弱的远程输出位，近身时停止攻击。', archetype: 'shooter', implementation: 'full', unlockLevel: '2-04', chapterAffinity: ['night'], tags: ['输出', '脆皮'], cost: 75, cooldownMs: 7000, maxHp: 220, damage: 25, attackIntervalMs: 1250, projectileKind: 'pea', projectileCount: 1 }),
  definePlant({ id: 'jumpingBean', name: '跳跳豆', shortName: '跳豆', summary: '位移控制位，击退风格控制卡。', archetype: 'special', implementation: 'full', unlockLevel: '9-07', chapterAffinity: ['lab'], tags: ['控制', '位移'], cost: 100, cooldownMs: 12000, maxHp: 260, damage: 90, attackIntervalMs: 1500 }),
  definePlant({ id: 'citron', name: '香橼', shortName: '橼', summary: '重炮型输出位，单发更重但间隔更长。', archetype: 'shooter', implementation: 'full', unlockLevel: '9-06', chapterAffinity: ['lab', 'all'], tags: ['输出', '重炮'], cost: 350, cooldownMs: 9500, maxHp: 300, damage: 90, attackIntervalMs: 2600, projectileKind: 'pea', projectileCount: 1 }),
  definePlant({ id: 'bloomerang', name: '回旋镖射手', shortName: '镖', summary: '穿透概念输出位，多线射手。', archetype: 'shooter', implementation: 'full', unlockLevel: '9-07', chapterAffinity: ['lab', 'all'], tags: ['输出', '穿透'], cost: 175, cooldownMs: 8500, maxHp: 300, damage: 26, attackIntervalMs: 1350, projectileKind: 'pea', projectileCount: 1, multiLane: 'adjacent' }),
  definePlant({ id: 'laserBean', name: '激光豆', shortName: '激', summary: '整线穿透概念位，高强直线输出。', archetype: 'shooter', implementation: 'full', unlockLevel: '10-01', chapterAffinity: ['lab', 'all'], tags: ['输出', '穿透'], cost: 200, cooldownMs: 8500, maxHp: 300, damage: 38, attackIntervalMs: 1450, projectileKind: 'shock', projectileCount: 1 }),
  definePlant({ id: 'bonkChoy', name: '菜问', shortName: '拳', summary: '高速近战连打位。', archetype: 'melee', implementation: 'full', unlockLevel: '10-02', chapterAffinity: ['all'], tags: ['近战', '连打'], cost: 150, cooldownMs: 7500, maxHp: 320, damage: 70, attackIntervalMs: 850 }),
  definePlant({ id: 'electricPea', name: '电能射手', shortName: '电', summary: '连锁输出概念位，高阶直线射手。', archetype: 'shooter', implementation: 'full', unlockLevel: '10-03', chapterAffinity: ['lab', 'all'], tags: ['输出', '连锁'], cost: 225, cooldownMs: 8500, maxHp: 300, damage: 32, attackIntervalMs: 1200, projectileKind: 'shock', projectileCount: 1 }),
  definePlant({ id: 'frostMelonVine', name: '冰西瓜藤', shortName: '冻藤', summary: '强控抛投位，冰瓜强化版。', archetype: 'lobber', implementation: 'full', unlockLevel: '10-04', chapterAffinity: ['roof', 'all'], tags: ['输出', '减速', '溅射'], cost: 450, cooldownMs: 9000, maxHp: 320, damage: 95, splashRadius: 3, attackIntervalMs: 2100, projectileKind: 'lobbed', projectileCount: 1 }),
  definePlant({ id: 'miniSunflower', name: '迷你太阳花', shortName: '小阳', summary: '高频低值产光位，适合紧凑节奏关。', archetype: 'economy', implementation: 'full', unlockLevel: '8-01', chapterAffinity: ['all'], tags: ['经济', '高频'], cost: 25, cooldownMs: 6000, maxHp: 220, producesSun: true, sunIntervalMs: 4000, sunAmount: 15 }),
  definePlant({ id: 'doubleCabbage', name: '双生卷心菜', shortName: '双菜', summary: '双抛投过渡位。', archetype: 'lobber', implementation: 'full', unlockLevel: '8-08', chapterAffinity: ['roof', 'all'], tags: ['输出', '抛投'], cost: 175, cooldownMs: 8000, maxHp: 300, damage: 35, attackIntervalMs: 1600, projectileKind: 'lobbed', projectileCount: 2 }),
  definePlant({ id: 'magnetBurstShroom', name: '磁暴菇', shortName: '磁暴', summary: '群体脱甲支援位，磁力菇强化版。', archetype: 'support', implementation: 'full', unlockLevel: '10-04', chapterAffinity: ['lab', 'night'], tags: ['控制', '脱甲'], cost: 175, cooldownMs: 14000, maxHp: 280, supportEffect: 'armor-strip' }),
  definePlant({ id: 'shieldBlossom', name: '护盾花', shortName: '盾', summary: '队友保护位，容器式防护。', archetype: 'support', implementation: 'full', unlockLevel: '10-03', chapterAffinity: ['all'], tags: ['保护', '支援'], cost: 125, cooldownMs: 10000, maxHp: 320, supportEffect: 'shield' }),
  definePlant({ id: 'auditBean', name: '审计豆', shortName: '审', summary: '项目专属高威胁标记位，高阶直线输出。', archetype: 'special', implementation: 'full', unlockLevel: '10-07', chapterAffinity: ['lab'], tags: ['特殊', '标记'], cost: 250, cooldownMs: 9000, maxHp: 300, damage: 45, attackIntervalMs: 1400, projectileKind: 'shock', projectileCount: 1 }),
];
